    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="td-card p-8 text-center">
          <h2 className="text-xl font-semibold text-td-primary-800 mb-6">
            TDキャラクター
          </h2>
          ...
          <div className="flex justify-center mb-6">
            <div className="text-center">
              ...
              {showBubble && (
                <div className="mt-4 bg-white border-2 border-td-primary-200 rounded-lg p-3 shadow-lg max-w-xs mx-auto">
                  <p className="text-sm text-td-primary-800">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div className="bg-td-primary-50 p-3 rounded-lg">
              <div className="font-medium text-td-primary-800">感情</div>
              <div className="text-td-primary-600">{currentEmotion}</div>
            </div>
            <div className="bg-td-primary-50 p-3 rounded-lg">
              <div className="font-medium text-td-primary-800">アニメーション</div>
              <div className="text-td-primary-600">{currentAnimation}</div>
            </div>
            <div className="bg-td-primary-50 p-3 rounded-lg">
              <div className="font-medium text-td-primary-800">サイズ</div>
              <div className="text-td-primary-600">{currentSize}</div>
            </div>
            <div className="bg-td-primary-50 p-3 rounded-lg">
              <div className="font-medium text-td-primary-800">吹き出し</div>
              <div className="text-td-primary-600">{showBubble ? '表示' : '非表示'}</div>
            </div>
          </div>
        </div>
                ...
                <button
                  ...
                  className={`td-button px-3 py-2 rounded-md text-sm ${
                    currentEmotion === emotion
                      ? 'bg-td-primary-500 text-white'
                      : 'bg-td-primary-100 text-td-primary-800 hover:bg-td-primary-200'
                  }`}
                >
                  {emotion}
                </button>
              ...
              <div>
                <label className="flex items-center space-x-2">
                  <input
                    ...
                    className="rounded border-td-primary-300"
                  />
                  <span className="text-td-primary-800">吹き出しを表示</span>
                </label>
              </div>
              <div>
                <label className="block text-sm font-medium text-td-primary-800 mb-2">
                  カスタムメッセージ
                </label>
                <textarea
                  value={customMessage}
      ...
      <div className="mt-12 td-card p-6">
        <h2 className="text-xl font-semibold text-td-primary-800 mb-4">
          使用例
        </h2>
