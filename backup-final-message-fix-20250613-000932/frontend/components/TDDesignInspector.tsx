    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="bg-orange-600 text-white p-3 rounded-full shadow-lg hover:bg-orange-700 transition-all transform hover:scale-105"
        ...
        {/* インスペクターパネル */}
        {isOpen && (
          <div className="absolute bottom-16 right-0 w-96 bg-white rounded-lg shadow-2xl border-2 border-orange-200 p-4 max-h-96 overflow-y-auto">
            {/* ヘッダー */}
