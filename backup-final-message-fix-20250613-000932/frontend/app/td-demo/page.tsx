    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="text-center mb-8">
        ...
        <p className="text-orange-600">
          Brewキャラクターの様々な表情・アニメーション・サイズを確認できます
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="td-card p-8 text-center">
          <h2 className="text-xl font-semibold text-orange-800 mb-6">
            Brewキャラクター
          </h2>
          ...
          <div className="flex justify-center mb-6">
            <div className="text-center">
              ...
              {showBubble && (
                <div className="mt-4 bg-white border-2 border-orange-200 rounded-lg p-3 shadow-lg max-w-xs mx-auto">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div className="bg-orange-50 p-3 rounded-lg">
              <div className="font-medium text-orange-800">感情</div>
              <div className="text-orange-600">{currentEmotion}</div>
            </div>
            <div className="bg-orange-50 p-3 rounded-lg">
              <div className="font-medium text-orange-800">アニメーション</div>
              <div className="text-orange-600">{currentAnimation}</div>
            </div>
            <div className="bg-orange-50 p-3 rounded-lg">
              <div className="font-medium text-orange-800">サイズ</div>
              <div className="text-orange-600">{currentSize}</div>
            </div>
            <div className="bg-orange-50 p-3 rounded-lg">
              <div className="font-medium text-orange-800">吹き出し</div>
              <div className="text-orange-600">{showBubble ? '表示' : '非表示'}</div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-4">
              <div>
                <label className="flex items-center space-x-2">
                  ...
                  />
                  <span className="text-orange-800">吹き出しを表示</span>
                </label>
              </div>
              <div>
