      ...
      {options.map((option) => (
        <div
          ...
          className={cn(
            ...
            option.selected
              ? 'border-td-primary-500 bg-gradient-to-br from-td-primary-50 to-td-primary-100 shadow-md'
              : 'border-gray-200 bg-white hover:border-td-primary-300 hover:shadow-md'
          )}
        >
          {/* 選択状態のオーバーレイ */}
          {option.selected && (
          ...
          <div className="p-4">
            <div className="flex items-center space-x-3 mb-2">
              ...
              <h3 className={cn(
                ...
                option.selected 
                  ? 'text-td-primary-700' 
                  : 'text-gray-700 group-hover:text-td-primary-600'
              )}>
                {option.label}
              </h3>
            </div>
