    ...
    <div className={`bg-white rounded-xl shadow-lg p-6 border border-td-gray-200 ${className}`}>
          ...
          <button
            ...
            className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${
              selectedCategory === 'all'
                ? 'bg-td-primary-100 text-td-primary-800 border-2 border-td-primary-300 shadow-sm'
      ...
      <div className="space-y-4">
        {filteredUseCases.map((useCase) => (
          <div
            key={useCase.id}
            className="border border-td-gray-200 rounded-xl p-6 hover:border-td-primary-300 hover:shadow-md transition-all duration-200 bg-white"
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <button
                ...
                className="ml-6 px-4 py-2 text-sm bg-td-primary-500 text-white rounded-lg hover:bg-td-primary-600 focus:ring-2 focus:ring-td-primary-200 transition-all duration-200 font-medium shadow-sm hover:shadow"
              >
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-td-primary-50 border border-td-primary-200 rounded-lg p-4">
                        <p className="text-sm font-medium text-td-primary-800 mb-2">🔑 UUID使用例</p>
                        <code className="text-sm text-td-primary-700 break-all font-mono">{useCase.uuidExample}</code>
                      </div>
