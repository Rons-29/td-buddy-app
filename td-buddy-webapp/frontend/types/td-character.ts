...
// 感情と絵文字のマッピング
export const EMOTION_EMOJIS: Record<TDEmotion, string> = {
  happy: '😊',
  excited: '🤩',
  thinking: '🤔',
  working: '😤',
...
// 感情と日本語ラベルのマッピング
export const EMOTION_LABELS: Record<TDEmotion, string> = {
  happy: 'ハッピー',
  excited: '興奮',
  thinking: '思考中',
  working: '作業中',
...
// デフォルトメッセージ
export const DEFAULT_MESSAGES: Record<TDEmotion, string[]> = {
  happy: [
    '嬉しいです！一緒に頑張りましょう♪',
    'いい感じですね！このまま進めましょう',
    '順調に進んでいますね！'
