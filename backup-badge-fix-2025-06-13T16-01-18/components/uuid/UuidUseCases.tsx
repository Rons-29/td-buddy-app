    ...
    <div className={`bg-white rounded-xl shadow-lg p-6 border border-td-gray-200 ${className}`}>
      ...
      <div className="space-y-4">
        {filteredUseCases.map((useCase) => (
          <div
            key={useCase.id}
            className="border border-td-gray-200 rounded-xl p-6 hover:border-orange-300 hover:shadow-md transition-all duration-200 bg-white"
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <button
                ...
                className="ml-6 px-4 py-2 text-sm bg-orange-500 text-white rounded-lg hover:bg-orange-600 focus:ring-2 focus:ring-td-primary-200 transition-all duration-200 font-medium shadow-sm hover:shadow"
              >
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                        <p className="text-sm font-medium text-orange-800 mb-2">🔑 UUID使用例</p>
                        <code className="text-sm text-orange-700 break-all font-mono">{useCase.uuidExample}</code>
                      </div>
      ...
      <div className="mt-8 bg-orange-50 border border-orange-200 rounded-xl p-6">
        <div className="flex items-start">
          ...
          <div>
            <p className="text-sm text-orange-800 font-semibold mb-2">ブリューからのアドバイス</p>
