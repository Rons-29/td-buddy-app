...
export class RealFileGenerator {
  ...
  async generateRealPDF(
    ...
    const sampleTexts = [
      ...
      'QA Workbench (TD) は QA エンジニアの最高の相棒です。',
      '効率的なテストデータ醸造で、品質向上をサポートします。',
      'このPDFファイルは実際に開くことができる本物のPDFです。',
      'ページを追加して目標サイズまで生成を続けます。',
      'ブリューと一緒に素晴らしいテストデータを作りましょう！',
    ];
    ...
    try {
      ...
      while (currentBytes < targetBytes) {
        ...
        // ページヘッダー
        pdf.setFontSize(16);
        pdf.text(`QA Workbench - Large PDF Test (Page ${pageCount})`, 20, 20);
        ...
        pdf.setFontSize(8);
        pdf.text(
          `Brew Assistant Generated PDF - Page ${pageCount} - ${new Date().toISOString()}`,
          20,
          290
        );
      ...
      pdf.text('Generated by QA Workbench (TD)', 20, 80);
