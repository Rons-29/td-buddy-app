...
const BrewCharacter: React.FC<BrewCharacterProps> = ({
  ...
  const getDefaultMessage = (emotion: BrewEmotion): string => {
    const messages = {
      happy: 'データ醸造の準備ができました！',
      excited: 'わくわく！新しいデータを醸造しましょう♪',
      working: 'データ醸造中です...しばらくお待ちください',
      thinking: 'どんなデータにしましょうか？🤔',
      success: '醸造完了！完璧なデータができました✨',
      ...
      brewing: '🍺 データを醸造中...美味しいデータができそうです♪',
      completed: '醸造完了！お役に立てて嬉しいです',
    };
