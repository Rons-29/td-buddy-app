...
const TDCharacter = dynamic(() => import('../../components/BrewCharacter'), {
  ssr: false,
  loading: () => (
    <div className="w-10 h-10 bg-brew-primary-200 rounded-full animate-pulse"></div>
  ),
});
    ...
    <div className="min-h-screen bg-gradient-to-br from-td-primary-50 via-white to-td-secondary-50">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-brew-primary-600 text-lg max-w-2xl mx-auto">
        ...
        <div className="max-w-full mx-auto grid grid-cols-1 lg:grid-cols-4 gap-6 h-[calc(100vh-200px)]">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-2xl shadow-xl border border-brew-primary-100 overflow-hidden h-full flex flex-col">
              {/* チャットヘッダー */}
              <div className="bg-gradient-to-r from-td-primary-500 to-td-accent-500 p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-brew-primary-100 text-sm">
                      自然言語データ醸造アシスタント
                    </p>
                  </div>
              ...
              {/* メッセージエリア */}
              <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-brew-primary-25">
                    ...
                    <div
                      className={`max-w-xs lg:max-w-md px-4 py-2 rounded-2xl ${
                        message.type === 'user'
                          ...
                          : 'bg-white text-brew-primary-800 border border-brew-primary-200 shadow-sm'
                      }`}
                    >
                ...
                {isLoading && (
                  <div className="flex justify-start">
                    <div className="bg-white text-brew-primary-800 border border-brew-primary-200 rounded-2xl px-4 py-2 shadow-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex gap-1">
                          <div className="w-2 h-2 bg-brew-primary-400 rounded-full animate-bounce"></div>
                          <div
                            className="w-2 h-2 bg-brew-primary-400 rounded-full animate-bounce"
              ...
              {/* 入力エリア */}
              <div className="p-4 border-t border-brew-primary-100 bg-white">
                <div className="flex gap-3">
                  <div className="flex-1 relative">
                    <input
                      ...
                      className="w-full px-4 py-3 border border-brew-primary-300 rounded-xl focus:ring-2 focus:ring-td-primary-500 focus:border-transparent outline-none transition-all"
                      disabled={isLoading}
                    />
                  </div>
                  <button
          ...
          <div className="space-y-4 h-full overflow-y-auto">
            ...
            {/* 接続状況 */}
            <div className="bg-white rounded-xl shadow-sm border border-brew-primary-100 p-4">
              <h3 className="text-sm font-semibold mb-2 flex items-center gap-2">
                {isConnected ? (
                  <>
                    <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                    <span className="text-brew-primary-800">🔗 接続状況</span>
                  </>
                ) : (
                  <>
              ...
              <p className="text-xs text-brew-primary-600">
            ...
            {lastGeneratedData && (
              <div className="bg-white rounded-xl shadow-sm border border-brew-primary-100 p-4">
                <h3 className="text-sm font-semibold mb-3 flex items-center gap-2">
                  <Database className="w-4 h-4 text-brew-primary-500" />
                  生成データ
                </h3>

                <div className="space-y-3">
                  <div className="bg-brew-primary-50 rounded-lg p-3">
                    <p className="text-xs text-brew-primary-600">生成件数</p>
                    <p className="text-xl font-bold text-brew-primary-600">
            ...
            {lastGeneratedData && (
              <div className="bg-white rounded-xl shadow-sm border border-brew-primary-100 p-4">
                <h3 className="text-sm font-semibold mb-3 text-brew-primary-800">
                  データプレビュー
                </h3>
                <div className="space-y-2 max-h-40 overflow-y-auto">
                  {lastGeneratedData.data.slice(0, 3).map((item, index) => (
                    <div
                      key={index}
                      className="bg-brew-primary-50 rounded-lg p-2 text-xs"
                    >
                      <div className="font-medium text-brew-primary-900">
                        {item.fullName?.kanji || item.fullName || 'N/A'}
                      </div>
                      <div className="text-brew-primary-600 truncate">
                        {item.email || 'メールなし'} •{' '}
                        {item.phone || '電話なし'}
                      </div>
                    </div>
                  ...
                  {lastGeneratedData.data.length > 3 && (
                    <div className="text-center text-brew-primary-500 text-xs py-1">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-brew-primary-100 p-4">
              ...
              <div className="space-y-3">
                ...
                {/* 自動保存の説明 */}
                <div className="bg-brew-primary-50 rounded-lg p-2 border border-brew-primary-200">
                  <p className="text-xs text-brew-primary-600">
                    💡
            ...
            {/* ヘルプ */}
            <div className="bg-gradient-to-r from-td-primary-50 to-td-accent-50 rounded-xl border border-brew-primary-100 p-4">
              <h3 className="text-sm font-semibold mb-3 text-brew-primary-800">
                💡 使い方のヒント
              </h3>
              <div className="space-y-2 text-xs text-brew-primary-700">
                <div className="flex items-start gap-2">
