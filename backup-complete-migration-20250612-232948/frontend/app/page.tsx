      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          ...
          <div className="td-card p-6">
            <div className="text-3xl mb-3">🧠</div>
            <h3 className="text-lg font-semibold text-brew-primary-800 mb-2">
              AI チャット
            </h3>
            <p className="text-brew-primary-600 mb-4">
              自然言語でデータ醸造条件を指定できます
            </p>
            <Link href="/ai-chat">
              <button className="td-button bg-brew-primary-500 text-white px-4 py-2 rounded-md hover:bg-brew-primary-600 transition-colors">
                チャット開始
              </button>
            </Link>
          </div>
