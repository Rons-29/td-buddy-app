      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-3 mb-4">
            <div className="w-12 h-12 bg-brew-primary-500 rounded-full flex items-center justify-center">
              <FileDown className="w-6 h-6 text-white" />
            </div>
            <h1 className="text-3xl font-bold text-brew-primary-900">
              ファイル出力機能強化
            </h1>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-md p-6 border border-td-gray-200 hover:shadow-lg transition-shadow">
            <div className="flex items-center space-x-3 mb-4">
              <Database className="w-8 h-8 text-brew-primary-500" />
              <h3 className="text-lg font-semibold text-brew-primary-800">データエクスポート</h3>
            </div>
            <p className="text-td-gray-600 mb-4">
              生成済みデータを様々な形式でエクスポート。バッチ処理と進捗表示対応。
            </p>
            <div className="flex flex-wrap gap-2">
              <span className="px-2 py-1 bg-brew-primary-100 text-brew-primary-700 rounded text-sm">JSON</span>
