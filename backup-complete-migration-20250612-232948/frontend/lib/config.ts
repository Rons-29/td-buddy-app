...
export const BREW_MESSAGES = {
  // 一般的なメッセージ
  WELCOME: 'こんにちは！Brewです。データ醸造のお手伝いをします♪',
  GOODBYE: 'お疲れさまでした！また一緒にデータを醸造しましょう',

  // 作業状態メッセージ
  BREWING_START: 'データ醸造を開始します！',
  BREWING_PROGRESS: 'データを醸造中です...しばらくお待ちください',
  BREWING_COMPLETE: '醸造完了！高品質なデータができあがりました✨',
  ...
  // 警告メッセージ
  LARGE_DATA_WARNING: '大量のデータです。醸造に時間がかかる場合があります',
