        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg border border-td-gray-200 p-6">
            ...
            <textarea
              ...
              className="w-full h-32 p-3 border border-td-gray-300 rounded-lg resize-none focus:ring-2 focus:ring-td-primary-500 focus:border-brew-primary-500 text-sm"
            />
          </div>
          ...
          <div className="bg-white rounded-lg border border-brew-primary-200 p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-brew-primary-800">
                ✨ 変換結果
              </h3>
              {convertedText && (
