      ...
      {options.map((option) => (
        <div
          ...
          className={cn(
            ...
            option.selected
              ? 'border-brew-primary-500 bg-gradient-to-br from-td-primary-50 to-td-primary-100 shadow-md'
              : 'border-gray-200 bg-white hover:border-brew-primary-300 hover:shadow-md'
          )}
        >
          {/* 選択状態のオーバーレイ */}
          {option.selected && (
          ...
          <div className="p-4">
            <div className="flex items-center space-x-3 mb-2">
              ...
              <h3 className={cn(
                ...
                option.selected 
                  ? 'text-brew-primary-700' 
                  : 'text-gray-700 group-hover:text-brew-primary-600'
              )}>
                {option.label}
              </h3>
            </div>
          ...
          <div className={cn(
            ...
            'bg-gradient-to-br from-td-primary-500/10 to-td-accent-500/10',
