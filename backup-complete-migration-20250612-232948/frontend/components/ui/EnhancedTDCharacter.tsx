    ...
    <div className={cn('relative flex flex-col items-center', className)}>
      ...
      {showSpeechBubble && currentMessage && (
        <div className="relative mb-4 max-w-xs">
          <div className="bg-white/95 backdrop-blur-sm border-2 border-brew-primary-200 rounded-2xl p-4 shadow-lg">
            <p className="text-sm text-brew-primary-800 font-medium text-center">
              {currentMessage}
            </p>
          </div>
          {/* Speech bubble tail */}
      ...
      <div
        ...
        className={cn(
          ...
          'border-4 border-brew-primary-300 shadow-xl',
      ...
      <div className={cn(
        ...
        'bg-brew-primary-100 text-brew-primary-800 border border-brew-primary-200'
      )}>
