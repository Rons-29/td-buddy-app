    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="bg-brew-primary-600 text-white p-3 rounded-full shadow-lg hover:bg-brew-primary-700 transition-all transform hover:scale-105"
        ...
        {/* インスペクターパネル */}
        {isOpen && (
          <div className="absolute bottom-16 right-0 w-96 bg-white rounded-lg shadow-2xl border-2 border-brew-primary-200 p-4 max-h-96 overflow-y-auto">
            {/* ヘッダー */}
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-bold text-brew-primary-800">
                🎨 TD Design Inspector
              </h3>
              <div className="flex gap-2">
                <button
                  ...
                  className={`p-2 rounded transition-colors ${
                    showGrid
                      ? 'bg-brew-primary-600 text-white'
            ...
            {/* 説明 */}
            <div className="bg-brew-primary-50 p-3 rounded-lg mb-4">
              <p className="text-sm text-brew-primary-700">
                {isInspectMode
