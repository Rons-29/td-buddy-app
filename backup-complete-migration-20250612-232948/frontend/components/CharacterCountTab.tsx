  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {/* 入力エリア */}
        <div className="space-y-6">
          <div className="bg-brew-primary-50 rounded-lg p-6 border border-brew-primary-200">
            <h3 className="text-lg font-semibold text-brew-primary-800 mb-4 flex items-center">
              ✍️ テキスト入力
            </h3>
            <textarea
              value={inputText}
              ...
              className="w-full h-64 p-3 border border-td-gray-300 rounded-lg resize-none focus:ring-2 focus:ring-td-primary-500 focus:border-brew-primary-500 text-sm font-mono"
            />
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg border border-td-secondary-200 p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="text-center p-3 bg-brew-primary-50 rounded border border-brew-primary-200">
                <div className="text-2xl font-bold text-brew-primary-700">{stats.totalLines}</div>
          ...
          <div className="bg-white rounded-lg border border-brew-primary-200 p-6">
            ...
            <div className="grid grid-cols-1 gap-3">
              <div className="flex justify-between items-center p-2 bg-brew-primary-50 rounded border border-brew-primary-200">
                <span className="text-sm font-medium text-td-gray-700">UTF-8</span>
                <span className="text-sm text-brew-primary-700 font-mono">{stats.encoding.utf8} bytes</span>
              </div>
