...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    const variants = {
      primary: 'bg-gradient-to-r from-orange-500 to-td-primary-600 hover:from-orange-600 hover:to-td-primary-700 text-white shadow-lg hover:shadow-xl focus:ring-td-primary-500',
      ...
      warning: 'bg-gradient-to-r from-td-secondary-500 to-amber-600 hover:from-td-secondary-600 hover:to-amber-700 text-white shadow-lg hover:shadow-xl focus:ring-td-secondary-500',
      ...
      ghost: 'text-orange-600 hover:bg-orange-50 hover:text-orange-700 focus:ring-td-primary-500'
    };
